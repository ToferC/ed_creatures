...
attribute-help = Enter value of attribute between 1 and 100.
other-help = Enter value between 0 and 100.
unconsciousness-help = Enter value of health rating between 0 and 1000. For creatures without an unconsciousness rating, enter the same as the death rating.
death-help = Enter value of health rating between 0 and 1000.
armor-help = Enter value of armor between 0 and 100.
defence-help = Enter value of defense between 0 and 100.
actions-help = Enter value of actions between 1 and 100.
movement-help = Enter text value of movement. You can put alternate movement types in brackets, i.e.: 12 (Flying 20).
